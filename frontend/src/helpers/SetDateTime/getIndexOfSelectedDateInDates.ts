 ...
 * - If we select `8/20` as our start
 * 	- We have a range from `8/15 --> 8/24` 
 * 	  - Our array will look like `[8/15, 8/16, 8/17, 8/18, 8/19, 8/20, 8/21, 8/22]` and our result should be `[8/20, 8/21, 8/22]`
 *
